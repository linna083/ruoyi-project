  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="图书类型ID" prop="typeId">
        <el-select v-model="queryParams.typeId" placeholder="请选择图书类型ID" clearable>
          <el-option
            v-for="dict in book_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图书类型ID" align="center" prop="typeId">
        <template #default="scope">
          <dict-tag :options="book_type" :value="scope.row.typeId"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="bookRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="图书类型ID" prop="typeId">
          <el-select v-model="form.typeId" placeholder="请选择图书类型ID">
            <el-option
              v-for="dict in book_type"
              :key="dict.value"
              :label="dict.label"
