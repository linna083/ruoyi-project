    ...
    <el-table v-loading="loading" :data="deptList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['dept:dept:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['dept:dept:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
const data = reactive({
  ...
  rules: {
    ...
    createBy: [
      { required: true, message: "部门录入者不能为空", trigger: "blur" }
    ]
  }
})
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除部门信息编号为"' + _deptIds + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('dept/dept/export', {
    ...queryParams.value
